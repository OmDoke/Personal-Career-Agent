  ...
  return (
    <div className="relative min-h-screen bg-slate-50 flex flex-col items-center py-16 px-4 overflow-hidden">
      ...
      <div className="max-w-5xl w-full text-center space-y-8 relative z-10 pt-10">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight text-center animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="pt-10 grid md:grid-cols-3 gap-8 text-left animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          <Card className="hover:-translate-y-1 transition-transform duration-300">
            <CardContent className="pt-6">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">1. Upload & Parse</h3>
          ...
          <Card className="hover:-translate-y-1 transition-transform duration-300">
            <CardContent className="pt-6">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">2. AI Gap Analysis</h3>
          ...
          <Card className="hover:-translate-y-1 transition-transform duration-300">
            <CardContent className="pt-6">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">3. Truthful Generation</h3>
